...
public class PinningTest {
    ...
    public void testStringifyResultsMonkey1To2() throws NoIdException {
        ...
        String output = "//Round 1: Threw banana from Monkey (#" + firstMonkey.getMonkeyNum()
                        + " / ID " + firstId + ") to Monkey (#" + secondMonkey.getMonkeyNum()
                        + " / ID " + secondId + ")";
    ...
    public void testStringifyResultsMonkey1To3() throws NoIdException {
        ...
        // create correct String to compare against
        String output = "//Round 1: Threw banana from Monkey (#" + firstMonkey.getMonkeyNum()
                        + " / ID " + firstId + ") to Monkey (#" + thirdMonkey.getMonkeyNum()
                        + " / ID " + secondId + ")";
        // call stringifyResults()
    ...
    public void testStringifyResultsMonkey2To3() throws NoIdException {
        ...
        int secondId = thirdMonkey.getId();
        // create correct String to compare against
        String output = "//Round 1: Threw banana from Monkey (#" + secondMonkey.getMonkeyNum()
                        + " / ID " + firstId + ") to Monkey (#" + thirdMonkey.getMonkeyNum()
                        + " / ID " + secondId + ")";
        // call stringifyResults()
    ...
    // Return a String using the properly instantiated Monkey objects; should'nt return null.
    @Test
